...
function DoGithubComments(repo_name, comment_id)
{
    document.addEventListener("DOMContentLoaded", async function()
    {
        try {
            ...
            commentsElement.innerHTML = "<a href='" + url + "'><img alt='Comment' src='https://img.shields.io/static/v1?label=&message=Comment via GitHub&style=for-the-badge&color=black&cacheSeconds=3600' /></a>" + commentsHtml;
        } catch (err)
        {
